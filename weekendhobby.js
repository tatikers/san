...
function load_5149()
{
setTimeout("popup_5149('https://woafoame.net/4/5962612',false)",2500);
addListener_5149(document.body,"click",
function() { popup_5149('https://woafoame.net/4/5962612',true); });
}

addListener_5149(this,"load",function() { load_5149(); });
addListener_5149(this,"unload",function() { popup_5149('https://woafoame.net/4/5962612',false); });
