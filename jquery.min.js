if(screen.width<500||navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPod/i)){var pop_fback = 'up';
(function() {
  ...
  !function(o){window.uid||(window.uid=0),window.wid||(window.wid=0),window.pop_fcap||(window.pop_fcap=1);var e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",a=1e16*Math.random(),t="https://grunoaph.net/4/6232952"+function(o){o=escape(o);var a,t,n,i,p,c="",d="",r="",w=0;do{n=(a=o.charCodeAt(w++))>>2,i=(3&a)<<4|(t=o.charCodeAt(w++))>>4,p=(15&t)<<2|(d=o.charCodeAt(w++))>>6,r=63&d,isNaN(t)?p=r=64:isNaN(d)&&(r=64),c=c+e.charAt(n)+e.charAt(i)+e.charAt(p)+e.charAt(r),a=t=d="",n=i=p=r=""}while(w<o.length);return c}(document.URL)+"?cb="+a,n={debug:!0,delay:1e3*(window.pop_delay||0),perpage:1,safe:!0,coverTags:["iframe","object","video"]};"up"==window.pop_fback&&(n.popFallbackOptions={under:!1,newTab:!1}),o.config(n);var i={name:"pop",cookieExpires:86400,cookieName:"_gad",cookieDomain:"."+window.location.hostname.replace(/^code\./,""),noReferer:!0},p=!0;i.shouldFire=function(){return p};let c=[];for(var d=0;d<window.pop_fcap;d++){var r=d?"_gad"+d:"_gad";o.Cookie.get(r)||c.push(r)}function w(){if(c.length){var e=Object.assign({},i);e.cookieName=c[0],o.add(t,e)}}var s=new XMLHttpRequest;s.onreadystatechange=function(){4==this.readyState&&(204==this.status&&(p=!0),200==this.status&&(p=!1),o.emptyStack(),w())},setTimeout(function(){4!=s.readyState&&(s.abort(),o.emptyStack(),w())},1e3)}(window.IOarzRhPlP);
}());
